...
\subsection{Base-Case Power Flow Validation}

Newton-Raphson converged in 4 iterations on the 117-bus network.
...
\subsection{Preliminary Training Performance}

Preliminary results confirm the operational correctness of the training pipeline. Microgrid agents showed positive reward trends even in early exploration.

\begin{table}[h]
\caption{Reward by Hierarchy Level (204 Steps)}
\centering
\begin{tabular}{lccc}
\toprule
...
Inverter Sub & 0.6694 & 0.0147 & $-0.0055$ \\
Renewable Sub & 0.3810 & 0.0525 & $-0.0998$ \\
Load Sub & 0.7878 & 0.0297 & $-0.0159$ \\
\bottomrule
\end{tabular}
\end{table}
